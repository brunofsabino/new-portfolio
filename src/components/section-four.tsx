    ...
    return (
        <section id="contact" className="p-12 flex flex-col items-center justify-center">
            <div className="mt-8 flex items-center flex-col font-sans">
                <h1 className="ml-2 text-3xl font-bold  text-primary">Contato</h1>
                <p>Escolha abaixo a forma de contato que preferir e clique para ser direcionado em uma nova aba!</p>
            </div>
